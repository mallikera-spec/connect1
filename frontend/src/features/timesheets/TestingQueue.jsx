...
import { ShieldCheck, AlertCircle, Clock, Search, Filter, CheckCircle2, X } from 'lucide-react'
    ...
    return (
        <div className="page-content">
            <div className="page-header">
                <div>
                    <h1>Testing Inbox</h1>
                    <p>Review and verify developer activities</p>
                </div>
                ...
                <div className="filter-grid">
                    <div className="form-group">
                        ...
                        <input
                            ...
                            placeholder="Activity or Developer..."
                            value={searchTerm}
            ...
            <style>{`
                ...
                .activity-cell { display: flex; flex-direction: column; gap: 2px; }
